...
local Window = Rayfield:CreateWindow({
    ...
    Discord = {
       Enabled = true,
       Invite = "https://discord.gg/gu4gW9z8zV", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD
    ...
    KeySettings = {
       ...
       Key = {"https://raw.githubusercontent.com/danielgamer9799/DanielCursedBSS/main/key.lua"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
 })
